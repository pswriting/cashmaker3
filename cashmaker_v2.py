...
[프드프 베스트셀러 목차 스타일]
목차만 봐도 "이 책 안 사면 손해"라는 느낌을 줘야 합니다.

챕터 제목 레퍼런스 (20자 이내):
- "월 300으로 3년 만에 1억 만든 비결"
- "99%가 모르는 부의 진짜 공식"
- "당신이 가난한 건 ○○ 때문이다"
- "부자들만 아는 '3가지 법칙'"
...
[핵심 테크닉]
1. 구체적 숫자 (300만원, 3년, 99%, 10분)
2. 비교 대조 (A vs B, 전 vs 후)
3. 빈칸 호기심 (○○○, '이것', '그 방법')
4. 도발적 단정 ("~는 거짓말", "절대 ~못한다")
5. 비밀/법칙 ("숨겨진", "진짜", "법칙")
